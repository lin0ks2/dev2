 ...
 * Version: 1.6.2 (header+footer style, legacy logic preserved)
 * Date: 2025-09-27
 *
 * Что изменено относительно 1.6.1 (safe patch):
 *  - Вместо <h2> добавлена шапка .modalHeader с <h3 class="modalTitle">…</h3>
 *  - Нижний отступ футера через .modalActions сохранён (совпадает со стилем Инфо)
 * Логика выбора языков/дека НЕ менялась.
 */
(function(){
  const LS = {
